...
//    StudentHomework toEntity(SubmissionRequestDto dto);
//
//
//    @BeanMapping(nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE)
//    void updateSubmissionFromDto(SubmissionRequestDto dto, @MappingTarget StudentHomework studentHomework);
//
//
//    @Mapping(source = "homework.title",target = "homeworkTitle")
//    @Mapping(source = "homework.file.id", target = "fileId")
//    SubmissionResponseDto toResponse(StudentHomework studentHomework);
//}
